...
test('전 블록의 지시문에 한글이 한 글자도 없다', () => {
  ...
  const built = {
    ...
    'E-1': P.incidentUser({ slotLabel: 'work', place: 'yard', tier: 'minor', event: 'a fall', category: 'injury during work', involved: [aSoldier], notices: ['no soccer'], abuseHere: [{ en: 'a senior grinding a junior down', by: 'Kim', to: 'Lee' }] }),
    ...
    'I-1': P.interviewSystem(ascii) + P.interviewOpen({ soldier: aSoldier, felt: { room: 'mid', work: 'mid', mood: 'low' }, honesty: 'guarded', question: 'how is it', suffered: [{ en: 'a senior grinding him down' }], guilty: true }) + P.interviewFollowup('and then'),
    'I-1(말없음)': P.interviewOpen({ soldier: aSoldier, felt: { room: 'mid', work: 'mid' }, honesty: 'guarded', question: 'how is it' }),
    'I-2': P.inspectSystem(ascii) + P.inspectUser({ place: 'yard', readings: { morale: 'low' }, when: 'midday (12:00)', caught: [{ en: 'one man standing while the others sit', grade: 'hazing' }] }),
