...
const TIPS = [
  ...
  '참고 · 일과 중 쓸 수 있는 것은 셋이다. 면담(상담) · 군기 점검 · 공지.',
  '참고 · 하루 첫 개입은 평판을 안 깎는다. 값이 붙는 것은 두 번째부터 — 「또 온다」가 소문이다.',
  '참고 · 개입이 한 번도 없는 조용한 날은 평판이 +1 회복된다. 조용한 날이 제일 싼 날이다.',
  '참고 · 평판이 낮으면 레버가 무뎌진다. 면담은 듣는 시늉만 하고, 점검은 가기 전에 방이 치워져 있다.',
  '참고 · 잔사건에 이름이 오르는 것은 군생활이다. 사람에게 남는 것은 중대 사건과 사고뿐이다.',
  '참고 · 분위기가 나쁜 밤에는 몇 명이 무너진다. 누가 무너질지는 아무도 모른다.',
