...
const TIPS = [
  ...
  '참고 · 가라는 자리에 붙고 부조리는 사람에 붙는다. 그래서 찾는 길도 다르다.',
  '참고 · 갈등·부조리 수치는 지금 돌고 있는 부조리의 건수다. 누가 누구에게 하는지는 안 알려준다.',
  '참고 · 부조리를 찾는 길은 둘이다. 그 자리 그 시간에 들이닥치거나, 당하는 놈을 불러 물어보거나.',
  '참고 · 가해자는 절대 제 입으로 안 분다. 계기판에서 멘탈이 낮은 놈을 부르는 눈이 곧 부조리를 찾는 눈이다.',
  '참고 · 아무도 안 말린 부조리는 무거워진다. 갈굼이 가혹행위가 되고, 가혹행위가 형사건이 된다.',
  '참고 · 형사건은 저절로 안 없어진다. 덮쳐야만 끊기고, 그때까지 그 사람은 계속 깎인다.',
  '참고 · 성과가 있는 급습은 분위기를 안 깎는다. 값이 붙는 것은 헛걸음이다.',
  '참고 · 단서는 관행 이름이 아니라 그 짝을 따라간다. 자라서 이름이 바뀌어도 누구를 봐야 하는지는 안다.',
  '참고 · 검열관은 서류를 본다. 부조리는 서류에 안 남는다 — 그건 주임원사 말고 아무도 안 잡는다.',
  '참고 · 끈끈한 부대일수록 자기들끼리 덮는다. 가라는 머리 좋은 부대가 숨기고, 부조리는 끈끈한 부대가 숨긴다.',
];
